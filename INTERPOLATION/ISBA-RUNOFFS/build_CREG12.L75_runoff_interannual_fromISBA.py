...
INDIR='./'
OUTDIR='../ISBA-CREG12.L75/'
RIVDIR='../INIT-SCRIPTS/ISBA-DATA-SET/'
...
### Read NEMO mesh 
filein2=INDIR+'CREG12.L75_domain_cfg_20210727_Z.nc'
...
filein3=INDIR+'mask.nc'
ncfile = netcdf(filein3,'r');
...
for year in range(1980,2023):
  ...
  print("Start the loop over years")
  if bissextile(year): 
     ntyear=366
  else:
     ntyear=365
...
#       if (i,j) in [(237,199),(261,179),(262,177),(181,238)]:
  ...
  # Ecriture fichier
  fileout=OUTDIR+'runoff_ISBA_daily_CREG12.L75-REF09_y'+str(year)+'.nc'
