...
for year in `seq $S_YEAR $E_YEAR `; do 
	...
	#for gtype in `echo gridT gridS gridU gridV`; do 
		...
		if [ ${gtype} == 'gridT' ] ;then 
			ncap2 -s "where(votemper == 50.) votemper=0." ${DIR}/GLORYS12V1-CREG12.L75_${area}_y${year}.1d_${gtype}_tmp.nc  ${DIR}/GLORYS12V1-CREG12.L75_${area}_y${year}.1d_${gtype}.nc
			ncatted -a missing_value,votemper,c,f,0. ${DIR}/GLORYS12V1-CREG12.L75_${area}_y${year}.1d_${gtype}.nc
		fi
		if [ ${gtype} == 'gridS' ] ;then 
			ncap2 -s "where(vosaline == 40.) vosaline=0." ${DIR}/GLORYS12V1-CREG12.L75_${area}_y${year}.1d_${gtype}_tmp.nc  ${DIR}/GLORYS12V1-CREG12.L75_${area}_y${year}.1d_${gtype}.nc
