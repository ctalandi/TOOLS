...
for year in `seq $S_YEAR $E_YEAR `; do 
	...
	for gtype in `echo gridU gridV `; do 
	#for gtype in `echo gridT gridS gridU gridV`; do 

		echo "		$gtype" 
	
		DIR="./OPERATE/${year}/${gtype}"
# Finally, the following step might not be usefull since _Fillvalue is alredy present after the interpolation step
#		if [ ${gtype} == 'gridT' ] ;then 
...
#		mv ${DIR}/GLORYS12V1-CREG12.L75_y${year}.1d_${gtype}.nc ${DATAOUT}/.
		mv ${DIR}/GLORYS12V1-CREG12.L75_y${year}.1d_${gtype}_tmp.nc ${DATAOUT}/GLORYS12V1-CREG12.L75_y${year}.1d_${gtype}.nc 
