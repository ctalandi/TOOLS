...
echo "Launching job ..."
echo "Submit : qsub -m n -v JLAB_LOG=$JLAB_LOG,DASHINFO=$DASHINFO,CONDAENV=$CONDAENV,PORTDIGIT=$PORTDIGIT jlab.pbs"
...
while true; do
    ...
    echo "Pas de log jlab.log, je retente dans 1 sec"
    sleep 1
done
