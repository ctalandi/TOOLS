...
#lst_dom=[area_bering,area_subtro,area_foldcr]
...
for dom_extra in lst_dom: 
    ...
    for var in bgcvar_lst:
        ...
        ldate = pd.date_range(start=str(my_year)+"0101",end=str(my_year)+"1231",freq="M") # all monday between start and end
        ...
        extra_data.to_netcdf(OUTDIR+dom_extra['AREA']+'/'+str(my_year)+'/'+CONFIG+'_'+dom_extra['AREA']+'_1m_y'+str(my_year)+'_'+var+'.nc')
