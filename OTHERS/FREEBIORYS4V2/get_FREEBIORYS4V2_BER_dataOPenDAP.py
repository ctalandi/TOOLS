...
# CAUTION  sur fichier ph pour annee 1995 bgcvar_lst=[ 'ph', 'phy2', 'phyc', 'phy', 'po4', 'poc', 'sfe', 'si', 'zoo2', 'zoo']
# Variable 'ph' is not accessible 
bgcvar_lst=['alk', 'bfe', 'caco3', 'chl', 'dchl', 'dfe', 'dic', 'doc', 'dsi', 'fe', 'goc', 'gsi', 'nchl', 'nfe', 'nh4', 'no3', 'nppv', 'o2', 'par']
...
for my_year in np.arange(1997,2024):
