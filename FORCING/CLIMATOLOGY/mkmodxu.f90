...
!!!----------------------------------------------------------------------------
  ...
  cfileu=TRIM(cprefix)//TRIM(cvaru)//'_'//TRIM(cset)//'_y'//TRIM(cyear)//'.nc'
  cfilev=TRIM(cprefix)//TRIM(cvarv)//'_'//TRIM(cset)//'_y'//TRIM(cyear)//'.nc'
  cfilewu=TRIM(cprefix)//TRIM(cvarwu)//'_'//TRIM(cset)//'_y'//TRIM(cyear)//'.nc'
  cfilewv=TRIM(cprefix)//TRIM(cvarwv)//'_'//TRIM(cset)//'_y'//TRIM(cyear)//'.nc'
  ...
  istatus=NF90_PUT_ATT(ncoutwu,id_varwu,'long_name','ERA5: 10m wind velocity x u10' )
  ...
  ! attributes of variable
  istatus=NF90_PUT_ATT(ncoutwv,id_varwv,'long_name','ERA5: 10m wind velocity x v10' )
