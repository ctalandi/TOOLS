...
!!!----------------------------------------------------------------------------
  ...
  INTEGER, PARAMETER :: jp_npd=24    ! number of point per day  ! 4 = ERA40, 8 = ERAinterim , 24 = ERA5 
  CHARACTER(LEN=80), PARAMETER :: cp_lonname='longitude', cp_latname='latitude', cp_timname='time'
  !----------------------------------------------------------------------------------------
  ! command line stuff
  INTEGER :: narg, iargc
