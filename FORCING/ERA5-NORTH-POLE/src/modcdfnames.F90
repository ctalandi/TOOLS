MODULE modCdfNames
  ...
  CHARACTER(LEN=256) :: cn_x='longitude'               !: longitude, I dimension
  CHARACTER(LEN=256) :: cn_y='latitude'               !: latitude,  J dimension
  ...
  CHARACTER(LEN=256) :: cn_vtimec  = 'time' !: time 
  ...
  CHARACTER(LEN=256) :: cn_ve3t1d='e3t', cn_ve3w1d='e3w'   !: e3.
